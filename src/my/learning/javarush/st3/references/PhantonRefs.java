...
public class PhantonRefs {
    ...
    public static class Helper {
        ...
        void consumeHeap() {
            try {
                List<PhantonRefs> heap = new ArrayList<PhantonRefs>(100000);
                while (true) {
                    heap.add(new PhantonRefs());
                }
        ...
        public List<PhantomReference<Monkey>> getPopulatedList() {
            ...
            for (int i=0; i<200; i++){
                Monkey m = new Monkey();
                phantomReferences.add(new PhantomReference<Monkey>(m,helper.getQueue()));
