...
public class CustomTreeAuthor extends AbstractList<String> implements Cloneable, Serializable {
    ...
    public boolean equals(Object o) {
        ...
        CustomTreeAuthor customTree = (CustomTreeAuthor) o;
    ...
    private class SolutionIterator implements Iterator<String> {
        ...
        public synchronized void remove() {
            ...
            CustomTreeAuthor.this.remove(list.get(lastReturned).elementName);
            index = lastReturned;
            lastReturned = -1;
            list = queue;
        }
